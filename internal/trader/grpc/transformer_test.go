...
func Test_transformStrategyTrade(t *testing.T) {
	t.Run("transforms strategy.Trade struct into StrategyTrade struct", func(t *testing.T) {
		t.Helper()
